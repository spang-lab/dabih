...
pub async fn find_user(configuration: &configuration::Configuration, find_user_request: models::FindUserRequest) -> Result<models::UserResponse, Error<FindUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_find_user_request = find_user_request;
    ...
    req_builder = req_builder.json(&p_find_user_request);
...
pub async fn remove_user(configuration: &configuration::Configuration, find_user_request: models::FindUserRequest) -> Result<(), Error<RemoveUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_find_user_request = find_user_request;
