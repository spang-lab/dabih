...
impl FileKeys {
    pub fn new(id: String, mnemonic: String, r#type: u32, name: String, tag: Option<String>, data_id: String, data: models::FileData, parent_id: Option<serde_json::Value>, created_at: String, updated_at: String, keys: Vec<models::Key>) -> FileKeys {
        FileKeys {
            id,
            mnemonic,
            r#type,
