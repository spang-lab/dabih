...
impl InodeMembers {
    pub fn new(id: Option<serde_json::Value>, mnemonic: String, r#type: f64, name: String, tag: Option<String>, parent_id: Option<serde_json::Value>, created_at: String, updated_at: String, members: Vec<models::Member>) -> InodeMembers {
        InodeMembers {
            id,
            mnemonic,
            r#type,
