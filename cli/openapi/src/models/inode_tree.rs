...
impl InodeTree {
    pub fn new(id: Option<serde_json::Value>, mnemonic: String, r#type: models::InodeType, name: String, tag: Option<String>, parent_id: Option<serde_json::Value>, created_at: String, updated_at: String, members: Vec<models::Member>, parent: Option<models::InodeMembersParent>, keys: Vec<models::Key>) -> InodeTree {
        InodeTree {
            id,
            mnemonic,
            r#type,
