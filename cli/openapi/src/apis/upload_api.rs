...
pub async fn cancel_upload(
    ...
    mnemonic: &str,
) -> Result<(), Error<CancelUploadError>> {
    ...
    let uri_str = format!(
        ...
        mnemonic = crate::apis::urlencode(p_path_mnemonic)
    );
...
pub async fn chunk_upload(
    ...
    digest: &str,
    chunk: Vec<u8>,
) -> Result<models::Chunk, Error<ChunkUploadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_mnemonic = mnemonic;
...
pub async fn finish_upload(
    configuration: &configuration::Configuration,
    mnemonic: &str,
) -> Result<models::File, Error<FinishUploadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_mnemonic = mnemonic;
...
pub async fn start_upload(
    configuration: &configuration::Configuration,
    upload_start_body: models::UploadStartBody,
) -> Result<models::File, Error<StartUploadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn unfinished_uploads(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::FileUpload>, Error<UnfinishedUploadsError>> {
