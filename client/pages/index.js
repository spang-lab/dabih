...
import ColorTest from '../components/util/ColorTest';
import {
  Container,
  BigButton,
  Institute,
    ...
    <div>
      ...
      <Container>
        ...
        <div className="mt-3 text-lg">
          ...
          <span className="text-main-200"> uploading </span>
          ,
          <span className="text-main-200"> storing </span>
          ,
          <span className="text-main-200"> sharing </span>
          and
          <span className="text-main-200"> downloading </span>
          arbirary data.
          <br />
          The
          <span className="text-main-200"> key </span>
          difference for dabih is that we
          <span className="font-semibold text-main-200"> guarantee </span>
          that no one except the people defined by dabih have access to the
          data, not even system administrators or people with pysical access to
          the hard-disks the data is stored on.
          <h3 className="text-xl font-extrabold tracking-tight sm:text-2xl md:text-3xl">
            <span className="text-main-200"> Symmetric </span>
            {' '}
            Cryptograpy
          </h3>
          ...
          When you upload data to dabih we generate a random key in memory and
          use symmetric encrytion (AES-256-CBC) to encrypt data before it is
          stored.
          <br />
          ...
          have 32 bytes.
          <h3 className="text-xl font-extrabold tracking-tight sm:text-2xl md:text-3xl">
            <span className="text-main-200"> Asymmetric </span>
            {' '}
            Cryptograpy
          </h3>
          ...
          <ul className="px-4 leading-relaxed list-disc">
            <li>
              ...
              <span className="font-semibold text-main-200"> encrypt </span>
              the data.
              <br />
              The public key will be sent to
              <span className="font-semibold text-main-200"> Dabih </span>
            ...
            <li>
              ...
              <span className="font-semibold text-main-200"> decrypt </span>
              the data.
              <br />
              The private key should
              <span className="font-semibold text-main-200"> never </span>
              be shared and
              <span className="font-semibold text-main-200"> only you </span>
              should have it.
            </li>
          </ul>
          <div className="relative w-full mx-auto lg:w-3/4 xl:w-2/3">
          ...
          <p>
            <span className="font-semibold text-main-200"> dabih </span>
            allows you to easily generate such a keypair on your computer and
            then send the public key to the server.
          </p>
          <p>
            You will only need to do this once, and for security reasons every
            key needs to be confirmed by an admin first.
          </p>
          <div className="relative w-full mx-auto lg:w-3/4 xl:w-2/3">
            <Image
          ...
          With this public key we can complete the upload and encrypt the AES
          key. The encrypted key is stored and can only be decrypted using the
          private key that
          <span className="font-semibold text-main-200"> dabih </span>
          does not have.
          <h3 className="text-xl font-extrabold tracking-tight sm:text-2xl md:text-3xl">
            <span className="text-main-200"> Download </span>
          </h3>
          If this dataset is downloaded a two-step decryption process is
          required.
          <span className="font-semibold text-main-200"> First </span>
          the encrypted AES key is downloaded and is decrypted using the private
          key. This results in the unencrypted AES key.
          <span className="font-semibold text-main-200"> Then </span>
          ...
          <span className="font-semibold text-main-200"> Note: </span>
          This guarantees that only the client with the private key can access
          the dataset.
          <h3 className="text-xl font-extrabold tracking-tight sm:text-2xl md:text-3xl">
            Data
            <span className="text-main-200"> Sharing </span>
          </h3>
          Of course we also need a way to safely share datasets with other
          users. Because
          <span className="font-semibold text-main-200"> dabih </span>
          ...
          <ul className="px-4 list-disc">
            <li>
              <span className="font-semibold text-main-200"> read </span>
              permission allows the user to download the dataset.
            </li>
            <li>
              <span className="font-semibold text-main-200"> write </span>
          ...
          There is now way to prevent others from having/keeping a copy of the
          dataset on a laptop or other storage medium.
          <h3 className="text-xl font-extrabold tracking-tight sm:text-2xl md:text-3xl">
            Data
            <span className="text-main-200"> Deletion </span>
          </h3>
          Generally users can also delete datasets from
          <span className="font-semibold text-main-200"> dabih </span>
          . But by
          default deletion does not remove the underlying files and keys, and
          the dataset can be recovered by an admin.
          <span className="font-semibold text-main-200"> dabih </span>
          {' '}
          admins
          can decide to
          <span className="font-semibold text-main-200"> destroy </span>
          {' '}
          and
          dataset. Destroying a dataset deletes all its data and is irrevokable.
          <h3 className="text-xl font-extrabold tracking-tight sm:text-2xl md:text-3xl">
            <span className="text-main-200"> Reencryption </span>
          </h3>
          <div className="relative w-full mx-auto lg:w-3/4 xl:w-2/3">
            <Image
