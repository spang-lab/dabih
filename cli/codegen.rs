...
base64url encoded*/
    ...
    #[serde(deny_unknown_fields)]
    pub enum ChunkData {}
    impl ::std::convert::From<&Self> for ChunkData {
    ...
    impl ::std::convert::From<&Self> for FileDownload {
    ...
    #[serde(deny_unknown_fields)]
    pub enum FileKeys {}
    impl ::std::convert::From<&Self> for FileKeys {
    ...
    #[serde(deny_unknown_fields)]
    pub enum FileUpload {}
    impl ::std::convert::From<&Self> for FileUpload {
    ...
    #[serde(deny_unknown_fields)]
    pub enum InodeMembers {}
    impl ::std::convert::From<&Self> for InodeMembers {
    ...
    #[serde(deny_unknown_fields)]
    pub enum InodeTree {}
    impl ::std::convert::From<&Self> for InodeTree {
...
If null the token will never expire*/
    ...
    impl ::std::convert::From<&Self> for TokenResponse {
