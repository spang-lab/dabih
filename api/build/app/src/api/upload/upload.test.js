...
test('upload start', async (t) => {
    ...
    const { response: response2, data: unfinished } = await api.upload.unfinished();
...
test('digest parsing', (t) => {
    ...
    t.is(parseDigest('sha-256=abc'), 'abc');
    t.is(parseDigest('SHA-256=n4bQgYhMfWWaL-qgxVrQFaO_TxsrC4Is0V1sFbDwCgg'), 'n4bQgYhMfWWaL-qgxVrQFaO_TxsrC4Is0V1sFbDwCgg');
